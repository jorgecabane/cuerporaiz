...
const entries: EmailEntry[] = [
  ...
  // ─── Sin gatillo: SOLO waitlist (planeado como flujo nuevo) ─────────────────
  {
    slug: "22-spot-freed",
    title: "Cupo liberado (waitlist) — pendiente de feature",
    trigger: "⚠ Sin gatillo — falta lógica de waitlist (planeado)",
    recipient: "Estudiante en lista de espera",
    status: "orphan",
    dto: buildSpotFreedEmail({
      ...
      endAt: END,
      location: "Av. O'Higgins 555, Pucón",
      bookUrl: `${BASE}/horarios/clase/abc123`,
      branding: B,
    }),
  },
