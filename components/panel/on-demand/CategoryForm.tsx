  ...
  return (
    <div className="rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
      ...
      <form action={handleSubmit} className="space-y-3">
        <div>
          <label htmlFor="cat-name" className="block text-sm font-medium text-[var(--color-text)] mb-1">
        ...
        <div>
          <label htmlFor="cat-description" className="block text-sm font-medium text-[var(--color-text)] mb-1">
        ...
        <div>
          <label htmlFor="cat-thumbnailUrl" className="block text-sm font-medium text-[var(--color-text)] mb-1">
        ...
        <div>
          <label htmlFor="cat-status" className="block text-sm font-medium text-[var(--color-text)] mb-1">
            Estado
          </label>
          <select
            id="cat-status"
